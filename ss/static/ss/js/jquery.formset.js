...
;(function($) {
    ...
    $.fn.formset.defaults = {
        ...
        deleteText: '&times;',            // Text for the delete link
        addCssClass: 'w3-closebtn w3-label',          // CSS class applied to the add link
        deleteCssClass: 'w3-closebtn w3-label',    // CSS class applied to the delete link
